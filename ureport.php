 ...
 <script src="js/wsub.js"></script>
	  ...
	  <?php 
							...
							else 
							{
								 ...
								 <script src="assets/modules/izitoast/js/iziToast.min.js"></script>
 <script src="js/werror.js"></script>
...
<?php 
        ...
        <div class="main-content">
			...
			<div class="section-header">
                    <h1><?php echo $udata['fname'].' '.$udata['lname'];?> Card Report</h1>
                </div>
			...
			<div class="row">
                ...
                <div class="section-header">
                    <h1><?php echo $udata['fname'].' '.$udata['lname'];?> Wallet Transaction Report</h1>
                </div>
				<div class="card">
