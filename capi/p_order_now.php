...
$table="tbl_order";
  $field_values=array("uid","odate","p_method_id","address","d_charge","cou_id","cou_amt","o_total","subtotal","trans_id","a_note","sid","vcommission","wall_amt","delivery_type","timeslot");
  $data_values=array("$uid","$timestamp","$p_method_id","$full_address","$d_charge","$cou_id","$cou_amt","$product_total","$product_subtotal","$transaction_id","$a_note","$store_id","$vcomission","$wall_amt","$delivery_type","$timeslot");
