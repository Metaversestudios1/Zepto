...
<div class="col-md-6 col-lg-6 col-xs-12 col-sm-12">
 	...
 	<div class="form-group">
									...
									<select name="area_id[]" id="sub_list" class="form-control" multiple  required>
...
<?php
								...
								<div class="col-md-6 col-lg-6 col-xs-12 col-sm-12">
									...
									<select name="scat[]" class="form-control" multiple required >
								...
								<textarea  rows="3" cols="4" class="form-control" name="raddress" required><?php echo $vinfo['address'];?></textarea>
								</div>
								</div>
...
<div class="col-md-6 col-lg-6 col-xs-12 col-sm-12">
 	...
 	<div class="form-group">
								...
								<div class="col-md-6 col-lg-6 col-xs-12 col-sm-12">
									<div class="form-group">
									<label for="cname">Store  Address</label>
								<textarea  rows="8" cols="8" class="form-control" name="raddress" required></textarea>
								</div>
								</div>
