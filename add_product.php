...
<div class="col-md-4 col-lg-4 col-xs-12 col-sm-12">
							...
							<select id="projectinput6" name="pincode[]" class="form-control"  multiple required>
...
<div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
								<div class="form-group">
									...
									<textarea class="form-control" rows="5" name="mdesc" id="mdesc" ><?php echo $sels['mdesc'];?></textarea>
								</div>
							</div>							
...
<div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
								<div class="form-group">
									<label for="cname">product Description </label>
									<textarea class="form-control" rows="5" id="mdesc" name="mdesc" ></textarea>
								</div>
							</div>							
