...
<script src="assets/modules/izitoast/js/iziToast.min.js"></script>
 <script src="js/passign.js"></script>
...
<?php 
						...
						else 
						{
							?>
<script src="assets/modules/izitoast/js/iziToast.min.js"></script>
 <script src="js/pkgerror.js"></script>
							<?php 
						}
					}
					?>
...
echo date_format($date,"d-m-Y");
											   ...
											   ?></td>
												<td class="width-200"><?php echo $row['paddress'];?></td>
												 <td><?php echo $row['pmobile'];?></td>
												 <td class="width-200"><?php echo $row['daddress'];?></td>
