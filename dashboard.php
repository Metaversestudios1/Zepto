...
if($_SESSION['ltype'] == 'Vendor')
				...
				<div class="row">
                   ...
                   <div class="col-lg-3 col-md-3 col-sm-12">
                    <div class="card card-statistic-2">
                        ...
                        <div class="card-icon shadow-primary bg-primary bold-font">
	...
	?>
	<a href="?shop=0"><button class="btn shadow-z-2 btn-danger margin-10">Make Shop Close</button></a>
	<?php }else { ?>
	<a href="?shop=1"><button class="btn shadow-z-2 btn-success margin-10">Make Shop Open</button></a>
	<?php } ?>
                        </div>
                        </div>
                    </div>
...
?>
<script src="assets/modules/izitoast/js/iziToast.min.js"></script>
 <script src="js/sclose.js"></script>
