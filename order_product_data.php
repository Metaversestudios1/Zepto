...
<div>
<input type='button' id='btn' class="btn btn-primary text-right cmd float-right" value='Print Order As Image' onclick='downloadimage();'>
</div>
...
?>
				  ...
				  <?php 
  if($c['delivery_type'] == 1)
  {
  ?>
  <div class="col-md-4">
                    <!-- Heading -->
                    <h6 class="text-muted mb-1">Timeslot:</h6>
                    <!-- Text -->
                    <p class="mb-0 font-size-sm font-weight-bold"><?php echo $c['timeslot'];?></p>
                  </div>
  <?php } ?>
              ...
              <div class="card style-2">
                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-12 col-md-6 bottom-10">
                      <!-- Heading -->
					   <?php 
  if($c['delivery_type'] == 0)
  {
