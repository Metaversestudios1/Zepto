...
else 
{
  ...
  $table="tbl_coupon";
  $store_id = $sdata['id'];
  $field_values=array("c_img","c_desc","c_value","c_title","status","cdate","ctitle","min_amt","sid","ulimit");
  $data_values=array("$target_file","$cdesc","$cvalue","$ccode","$cstatus","$cdate","$ctitle","$minamt","$store_id","$ulimit");
...
?>
<script src="assets/modules/izitoast/js/iziToast.min.js"></script>
 <script src="js/coupon-insert.js"></script>  
<?php 
}
...
$table="tbl_coupon";
  $field=array('ulimit'=>$ulimit,'c_img'=>$target_file,'c_desc'=>$cdesc,'c_value'=>$cvalue,'c_title'=>$ccode,'status'=>$cstatus,'cdate'=>$cdate,'ctitle'=>$ctitle,'min_amt'=>$minamt);
...
?>
<script src="assets/modules/izitoast/js/iziToast.min.js"></script>
 <script src="js/coupon-update.js"></script>
...
<?php 
	...
	else 
	{
		...
		$table="tbl_coupon";
  $field=array('ulimit'=>$ulimit,'c_desc'=>$cdesc,'c_value'=>$cvalue,'c_title'=>$ccode,'status'=>$cstatus,'cdate'=>$cdate,'ctitle'=>$ctitle,'min_amt'=>$minamt);
  $where = "where id=".$_GET['id']."";
$h = new Common();
	  $check = $h->UpdateData($field,$table,$where);
if($check == 1)
...
<div class="col-md-3 col-lg-3 col-xs-12 col-sm-12">
 ...
 <div class="col-md-3 col-lg-3 col-xs-12 col-sm-12">
                  ...
                  onkeypress="return event.charCode >= 48 && event.charCode <= 57" required >
							...
							<div class="col-md-3 col-lg-3 col-xs-12 col-sm-12">
								<div class="form-group">
									<label for="cname">Coupon Limit Uses</label>
									<input type="number" id="cname" class="form-control"  value="<?php echo $sels['ulimit'];?>" name="ulimit" 
                  onkeypress="return event.charCode >= 48 && event.charCode <= 57" required >
								</div>
							</div>
 ...
 <div class="col-md-3 col-lg-3 col-xs-12 col-sm-12">
                  ...
                  onkeypress="return event.charCode >= 48 && event.charCode <= 57" required >
							...
							<div class="col-md-3 col-lg-3 col-xs-12 col-sm-12">
								<div class="form-group">
									<label for="cname">Coupon Limit Uses</label>
									<input type="number" id="cname" class="form-control"  name="ulimit" 
                  onkeypress="return event.charCode >= 48 && event.charCode <= 57" required >
								</div>
							</div>
